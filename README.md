...
самой лепры**: лента уведомлений и пометка их прочитанными, подгрузка превью
видео, а также отправка голоса и ответа из окна уведомлений — обе по
настройке и обе по умолчанию выключены.

В куки на домене лепры пишет свои настройки и токен для тех же запросов —
без куки настройки на подлепрах расходились бы с настройками на главной.
Чужих кук не читает.
